<template>
  <div class="design-intelligence-page">
    ...
    <main class="page-content">
      <div class="container">
        <section id="methodology_discovery" class="interface-section">
        ...
        <section id="methodology_execution" class="interface-section">
        ...
        <section class="interface-section logic-patterns">
          ...
          <div class="patterns-section">
            ...
            <div class="methodology-card pattern-type">
              <h5>User Journey To Solution</h5>
            </div>
            <div class="methodology-card pattern-type">
              <h5>Cynefin Framework Application</h5>
            </div>
            <div class="methodology-card pattern-type">
              <h5>Analogical Thinking</h5>
            </div>
            <div class="methodology-card pattern-type">
              <h5>Nudge Technique Application</h5>
            </div>
            </div>
          </div>
...
const apmlSpec = {
  ...
  "interfaces": {
    "methodology_discovery": {
          ...
          "sections": {
            "category_overview": {
              ...
              "items": {
                ...
                "title": {
                  "title": "Title",
                  "description": "Strategic Business Design",
                  "properties": {},
                  "methodology": {},
                  "educationalContent": {},
                  "type": "content"
                ...
                "methods_count": {
                  "title": "Methods Count",
                  "description": "count methods where category is business_model",
                  "properties": {},
                  "methodology": {},
                  "educationalContent": {},
                  "type": "methodology"
          ...
          "sections": {
            "method_card": {
              ...
              "items": {
                ...
                "time_estimate": {
                  "title": "Time Estimate",
                  "description": "method.time_required",
                  "properties": {},
                  "methodology": {},
                  "educationalContent": {},
                  "type": "methodology"
                ...
                "complexity_indicator": {
                  ...
                  "description": "method.complexity_level",
                  "properties": {},
                  "methodology": {},
                  "educationalContent": {},
                  "type": "methodology"
          ...
          "sections": {
            "context_form": {
              ...
              "items": {
                ...
                "problem_type_selector": {
                  "title": "Problem Type Selector",
                  "description": "customer_experience | business_strategy | product_innovation | service_improvement | organizational_change",
                  "properties": {},
                  "methodology": {},
                  "educationalContent": {},
                  "type": "content"
                ...
                "experience_level": {
                  ...
                  "description": "novice | intermediate | expert",
                  "properties": {},
                  "methodology": {},
                  "educationalContent": {},
                  "type": "content"
      ...
      "flows": [
        {
          "trigger": "user",
          "action": "clicks_category_section",
          "type": "user_to_app"
        },
        {
          "trigger": "user",
          "action": "submits_context_form",
          "type": "user_to_app"
        }
      ],
      "content": {},
            ...
            "preparation_phase": {
              ...
              "items": {
                "required_materials": {
                  ...
                  "description": "selected_method.tools_needed",
                  "properties": {},
                  "methodology": {},
                  "educationalContent": {},
                  "type": "content"
                ...
                "time_allocation": {
                  ...
                  "description": "selected_method.time_required",
                  "properties": {},
                  "methodology": {},
                  "educationalContent": {},
                  "type": "content"
                ...
                "success_metrics": {
                  ...
                  "description": "selected_method.success_criteria",
                  "properties": {},
                  "methodology": {},
                  "educationalContent": {},
                  "type": "content"
          ...
          "sections": {
            "step_card": {
              ...
              "items": {
                ...
                "next_action": {
                  "title": "Next Action",
                  "description": "step.transition_logic",
                  "properties": {},
                  "methodology": {},
                  "educationalContent": {},
                  "type": "content"
            ...
            "integration_guidance": {
              ...
              "items": {
                "when multiple_methods_in_stack": {
                  "title": "When Multiple Methods In Stack",
                  "description": "",
                  "properties": {},
                  "methodology": {},
                  "educationalContent": {},
  ...
  "logic": {
    ...
    "framework_transformation_patterns": {
      "processes": {},
      "workflows": {},
      "patterns": {
        "user_journey_to_solution": {
          "name": "user_journey_to_solution",
          "steps": [],
          "description": "",
          "methodology": {},
          "applications": []
    ...
    "complexity_navigation": {
      ...
      "workflows": {},
      "patterns": {
        "cynefin_framework_application": {
          "name": "cynefin_framework_application",
          "steps": [],
          "description": "",
          "methodology": {},
          "applications": []
    ...
    "behavioral_design_patterns": {
      ...
      "workflows": {},
      "patterns": {
        "nudge_technique_application": {
          "name": "nudge_technique_application",
          "steps": [],
          "description": "",
          "methodology": {},
          "applications": []
...
const DesignMethod = ref({
  id: "",
})

const TransformationPattern = ref({
  id: "",
})
...
// Computed properties for interface elements
const methodology_discoveryElements = computed(() => ({
  framework_library: {
    type: 'display',
    properties: {},
    content: {"category_overview":{}}
  },
  detailed_methods: {
    type: 'display',
    properties: {},
...
const methodology_executionElements = computed(() => ({
  selected_framework_guide: {
    type: 'display',
    properties: {},
    content: {"preparation_phase":{}}
  },
  process_steps: {
    type: 'display',
    properties: {},
    content: {"step_card":{},"integration_guidance":{}}
  },
  handoff_points: {
    type: 'display',
    properties: {},
