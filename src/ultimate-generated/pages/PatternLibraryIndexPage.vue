<template>
  <div class="pattern-library-index-page">
    <header class="page-header">
      <div class="container">
        <h1 class="page-title">The Future of Systematic Innovation</h1>
        <p class="page-subtitle">Evidence-based approaches to understanding users and markets</p>
      </div>
    </header>
    <main class="page-content">
      <div class="container">
        <section id="pattern_discovery" class="interface-section">
          <h2 >Pattern Discovery</h2>
          <div class="content-block">
            <h3 class="block-title">Library Overview</h3>
              <div class="subsection">
                <h4 class="subsection-title">Domain Categories</h4>
                <div class="items-list">
                  <div class="list-item">
                    <h5 class="item-title">Design Intelligence Domain</h5>
                  </div>
                  <div class="list-item">
                    <h5 class="item-title">Title</h5>
                    <p class="item-description">User Research & Insight Generation</p>
                  </div>
                  <div class="list-item">
                    <h5 class="item-title">Description</h5>
                    <p class="item-description">Evidence-based approaches to understanding users and markets</p>
                  </div>
                  <div class="list-item">
                    <h5 class="item-title">Pattern Count</h5>
                    <p class="item-description">22</p>
                  </div>
                  <div class="list-item">
                    <h5 class="item-title">Complexity Range</h5>
                    <p class="item-description">Beginner to Advanced</p>
                  </div>
                  <div class="list-item">
                    <h5 class="item-title">Key Frameworks</h5>
                    <p class="item-description">[Thematic Analysis, Persona Development, Pain Point Prioritization, Behavioral Segmentation]</p>
                  </div>
                  <div class="list-item">
                    <h5 class="item-title">Business Strategy Domain</h5>
                  </div>
                  <div class="list-item">
                    <h5 class="item-title">Research Methodology Domain</h5>
                  </div>
                </div>
              </div>
          </div>
          <div class="content-block">
            <h3 class="block-title">Detailed Pattern Library</h3>
              <div class="subsection">
                <h4 class="subsection-title">Pattern Card</h4>
                <div class="items-list">
                  <div class="list-item">
                    <h5 class="item-title">Name</h5>
                    <p class="item-description">pattern.name</p>
                  </div>
                  <div class="list-item">
                    <h5 class="item-title">Complexity Indicator</h5>
                    <p class="item-description">pattern.complexity_level</p>
                  </div>
                  <div class="list-item">
                    <h5 class="item-title">Duration Estimate</h5>
                    <p class="item-description">pattern.time_required</p>
                  </div>
                  <div class="list-item">
                    <h5 class="item-title">Prerequisites</h5>
                    <p class="item-description">pattern.required_skills</p>
                  </div>
                  <div class="list-item">
                    <h5 class="item-title">Outcomes</h5>
                    <p class="item-description">pattern.expected_results</p>
                  </div>
                  <div class="list-item">
                    <h5 class="item-title">Use Cases</h5>
                    <p class="item-description">pattern.best_applied_when</p>
                  </div>
                </div>
              </div>
              <div class="subsection">
                <h4 class="subsection-title">Smart Recommendation Engine</h4>
              </div>
          </div>
          <div class="content-block">
        ...
        <section id="guided_learning_paths" class="interface-section">
          <h2 >Guided Learning Paths</h2>
          <div class="content-block">
            <h3 class="block-title">Curated Learning Journeys</h3>
          </div>
          <div class="content-block">
            <h3 class="block-title">Personalized Curriculum</h3>
          </div>
        </section>
        <section class="interface-section logic-patterns">
          ...
          <div class="patterns-section">
            ...
            <div class="methodology-card pattern-type">
              <h5>Research To Strategy Pipeline</h5>
            </div>
            <div class="methodology-card pattern-type">
              <h5>Success Pattern Identification</h5>
            </div>
            </div>
          </div>
...
const apmlSpec = {
            ...
            "domain_categories": {
              ...
              "items": {
                "design_intelligence_domain": {
                  "title": "Design Intelligence Domain",
                  "description": "",
                  "properties": {},
                  "methodology": {},
                  "educationalContent": {},
                ...
                "title": {
                  "title": "Title",
                  "description": "User Research & Insight Generation",
                  "properties": {},
                  "methodology": {},
                  "educationalContent": {},
                  "type": "content"
                ...
                "key_frameworks": {
                  ...
                  "description": "[Thematic Analysis, Persona Development, Pain Point Prioritization, Behavioral Segmentation]",
                  "properties": {},
                  "methodology": {},
                  "educationalContent": {},
                  "type": "methodology"
                ...
                "research_methodology_domain": {
                  "title": "Research Methodology Domain",
                  "description": "",
                  "properties": {},
                  "methodology": {},
                  "educationalContent": {},
            ...
            "pattern_card": {
              ...
              "items": {
                ...
                "complexity_indicator": {
                  ...
                  "description": "pattern.complexity_level",
                  "properties": {},
                  "methodology": {},
                  "educationalContent": {},
                  "type": "methodology"
                ...
                "duration_estimate": {
                  ...
                  "description": "pattern.time_required",
                  "properties": {},
                  "methodology": {},
                  "educationalContent": {},
                  "type": "methodology"
                ...
                "prerequisites": {
                  "title": "Prerequisites",
                  "description": "pattern.required_skills",
                  "properties": {},
                  "methodology": {},
                  "educationalContent": {},
                  "type": "methodology"
                ...
                "outcomes": {
                  "title": "Outcomes",
                  "description": "pattern.expected_results",
                  "properties": {},
                  "methodology": {},
                  "educationalContent": {},
                  "type": "methodology"
                ...
                "use_cases": {
                  "title": "Use Cases",
                  "description": "pattern.best_applied_when",
                  "properties": {},
                  "methodology": {},
                  "educationalContent": {},
                  "type": "methodology"
  ...
  "logic": {
    ...
    "cross_domain_integration": {
      ...
      "patterns": {
        "research_to_strategy_pipeline": {
          "name": "research_to_strategy_pipeline",
          "steps": [],
          "description": "",
          "methodology": {},
          "applications": []
    ...
    "adaptive_methodology_evolution": {
      "processes": {},
      "workflows": {},
      "patterns": {
        "success_pattern_identification": {
          "name": "success_pattern_identification",
          "steps": [],
          "description": "",
          "methodology": {},
          "applications": []
...
// Computed properties for interface elements
const pattern_discoveryElements = computed(() => ({
  library_overview: {
    type: 'display',
    properties: {},
    content: {"domain_categories":{}}
  },
  detailed_pattern_library: {
    type: 'display',
    properties: {},
    content: {"pattern_card":{},"smart_recommendation_engine":{}}
  },
  context_assessment: {
    type: 'display',
    properties: {},
...
const guided_learning_pathsElements = computed(() => ({
  curated_learning_journeys: {
    type: 'display',
    properties: {},
    content: {}
